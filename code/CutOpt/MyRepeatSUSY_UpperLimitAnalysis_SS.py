...
ndata     =  inputNdata 	# Number of events observed in data
nbkg      =  inputNbkg	 	# Number of predicted bkg events
#ndata     =  5. 	# Number of events observed in data
#nbkg      =  3.6	 	# Number of predicted bkg events
...
ucb = Systematic("uncorrl_bkg", configMgr.weights, 1.20,0.80, "user","userOverallSys")  # 20% error up and down
