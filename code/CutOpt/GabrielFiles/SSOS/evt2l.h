...
// Thu Aug  4 11:20:54 2016 by ROOT version 6.04/14
// from TTree evt2l/a angles tree
// found on file: /afs/cern.ch/work/c/clo/public/ntuple/AnalysisBase-02-04-15-414351/v7.2.361106.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Zee.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxjets = 27;
   static const Int_t kMaxtruths = 14;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/c/clo/public/ntuple/AnalysisBase-02-04-15-414351/v7.2.361106.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Zee.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/c/clo/public/ntuple/AnalysisBase-02-04-15-414351/v7.2.361106.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Zee.root");
      }
