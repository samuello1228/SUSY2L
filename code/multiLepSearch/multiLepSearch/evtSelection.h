#ifndef multiLepSearch_evtSelection_H
#define multiLepSearch_evtSelection_H
...
class evtSelection : public EL::Algorithm
{
...
public:
  ...
  evtSelection (std::string name="evtSelection");
  ...
  void fillLepton(susyEvts* m_susyEvt, xAOD::IParticle* p, L_PAR& l, unsigned int i);
