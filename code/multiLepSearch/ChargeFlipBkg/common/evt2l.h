...
// Mon Jun 19 10:32:47 2017 by ROOT version 6.04/14
// from TTree evt2l/a angles tree
// found on file: /eos/atlas/user/c/clo/ntuple/AnalysisBase-02-04-30-f15e6058/user.clo.v9.3.data15_13TeV.periodD.physics_Main_myOutput.root/user.clo.11238775._000002.myOutput.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxtruths = 1;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/atlas/user/c/clo/ntuple/AnalysisBase-02-04-30-f15e6058/user.clo.v9.3.data15_13TeV.periodD.physics_Main_myOutput.root/user.clo.11238775._000002.myOutput.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/atlas/user/c/clo/ntuple/AnalysisBase-02-04-30-f15e6058/user.clo.v9.3.data15_13TeV.periodD.physics_Main_myOutput.root/user.clo.11238775._000002.myOutput.root");
      }
