...
const string EVT_s = "run/l:event/l:lumiBlock/l:actualMu/l:index/i:cuts/i:trig/i:flag/I:pass/I:averageMu/F:Xsec/F:weight/F:pwt/F:ElSF/F:MuSF/F:BtagSF/F:qFwt";
struct SIGNATURE{
