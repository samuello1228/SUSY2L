...
const string L_PAR_s = PAR_s+":topoetcone20/F:topoetcone30:topoetcone40:ptcone20:ptcone30:ptcone40:mT:d0:d0Err:z0:z0Err:truthProb:SF_Loose:SF_Medium:SF_Tight:wt1:wt2:wt3:ID/I:author/I:truthI/I:truthType:truthOrig:Q/i:lFlag/i:nBHits/i:nPixHits:nSCTHits:nPixHoles:nSCTHoles:nTRTHits:nTRTOutliers";
...
const string EVT_s = "run/l:event/l:lumiBlock/l:averageMu/l:actualMu/l:index/i:cuts/i:trig/i:flag/I:pass/I:weight/F:ElSF/F:MuSF/F";
struct SIGNATURE{
...
const string SIGNATURE_s = "trigCode/l:Met/F:MetRel/F:MetX/F:MetY/F:mT2/F:nEl/i:nMu/i:nTau/i:nJet/i:nPV/i:nVtx/i";
