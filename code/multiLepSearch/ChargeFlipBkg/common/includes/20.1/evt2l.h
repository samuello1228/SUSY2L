...
// Wed Mar  9 10:48:01 2016 by ROOT version 6.04/14
// from TTree evt2l/a angles tree
// found on file: /afs/cern.ch/work/c/clo/public/ntuple/AnalysisSUSY-02-03-45-405704/v6.3.s.00276262.physics_Main.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static const Int_t kMaxleps = 2;
   static const Int_t kMaxjets = 9;
   static const Int_t kMaxtruths = 6;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/c/clo/public/ntuple/AnalysisSUSY-02-03-45-405704/v6.3.s.00276262.physics_Main.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/c/clo/public/ntuple/AnalysisSUSY-02-03-45-405704/v6.3.s.00276262.physics_Main.root");
      }
