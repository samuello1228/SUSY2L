...
// Mon Aug  8 19:03:29 2016 by ROOT version 6.04/14
// from TTree evt2l/a angles tree
// found on file: /afs/cern.ch/work/c/clo/public/ntuple/AnalysisBase-02-04-15-414351/v7.2.410000.PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_nonallhad.root
//////////////////////////////////////////////////////////

#ifndef ttbar_checks_h
#define ttbar_checks_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static const Int_t kMaxleps = 5;
   static const Int_t kMaxjets = 29;
   static const Int_t kMaxtruths = 22;
   ...
   ttbar_checks(TTree *tree=0);
   virtual ~ttbar_checks();
...
#ifdef ttbar_checks_cxx
ttbar_checks::ttbar_checks(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/c/clo/public/ntuple/AnalysisBase-02-04-15-414351/v7.2.410000.PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_nonallhad.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/c/clo/public/ntuple/AnalysisBase-02-04-15-414351/v7.2.410000.PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_nonallhad.root");
      }
...
Int_t ttbar_checks::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ttbar_checks::LoadTree(Long64_t entry)
{
...
void ttbar_checks::Init(TTree *tree)
{
...
void ttbar_checks::Show(Long64_t entry)
{
...
Int_t ttbar_checks::Cut(Long64_t entry)
{
