...
../multiLepSearch/util/run_ss_selection.py --driver grid -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --outputTag ${tag} -o ${k} -w -a 1 --study fakes --mcMatch MCTCZ --doSys 0 --ChargeID 1 --conf ${SUSYconf}
...
k=${tag}.Sherpa
file=/eos/atlas/user/g/ggallard/xAOD_forTesting/mc15_13TeV.364118.Sherpa_221_NNPDF30NNLO_Zee_MAXHTPTV70_140_CFilterBVeto.merge.DAOD_SUSY2.e5299_s2726_r7772_r7676_p2949/DAOD_SUSY2.11084342._000011.pool.root.1
../multiLepSearch/util/run_ss_selection.py --driver grid -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --outputTag ${tag} -o ${k} -w -a 1 --study fakes --mcMatch dRZ --doSys 0 --ChargeID 1 --conf ${SUSYconf}
