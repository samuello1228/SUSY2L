...
# tag='zX_0'
# ### ZPH test
# ../multiLepSearch/util/run_zph_selection.py -f /home/dzhang/links/SAMPLES/R20/Data15/DxAOD/MUON3/data16_13TeV.00308084.physics_Main.merge.DAOD_MUON3.f741_m1673_p2950/DAOD_MUON3.10306404._000046.pool.root.1 --dataPRW ${dataPRW} --grl ${grl} --outputTag ${tag} -o testD -w -a 0 --study ss --doSys 0
