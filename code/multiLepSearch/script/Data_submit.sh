...
k=${tag}.data 
../multiLepSearch/util/run_ss_selection.py --driver grid --inputList ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --grl ${grl} --outputTag ${k} -o ${k} -a 0 --study ss --doSys 0  --conf ${SUSYconf} --fast
...
#../multiLepSearch/util/run_ss_selection.py --driver direct -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --grl ${grl} -o t1 -w -a 0 --study ss --doSys 0  --conf ${SUSYconf} # --cutflow | tee cutflow.log
