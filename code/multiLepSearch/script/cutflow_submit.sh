...
if true; then
    ...
    ../multiLepSearch/util/run_ss_selection.py --driver direct -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --outputTag ${tag} -o ${k} -w -a 1 --study ${st} --mcMatch MCTC --doSys 0 --ChargeID 1 --conf ${SUSYconf} --printEvent 10566 | tee Sig.log  
    ...
    ../multiLepSearch/util/run_ss_selection.py --driver direct -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --outputTag ${tag} -o ${k} -w -a 1 --study ${st} --mcMatch dR --doSys 0 --ChargeID 1 --conf ${SUSYconf} --printEvent 47 | tee Zmm.log 
    ...
    ../multiLepSearch/util/run_ss_selection.py --driver direct -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --outputTag ${tag} -o ${k} -w -a 1 --study ${st} --mcMatch MCTC --doSys 0 --ChargeID 1 --conf ${SUSYconf} --printEvent 5799815  | tee ttbar.log 
    ...
    ../multiLepSearch/util/run_ss_selection.py --driver direct -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --outputTag ${tag} -o ${k} -w -a 1 --study ${st} --mcMatch MCTC --doSys 0 --ChargeID 1 --conf ${SUSYconf} --printEvent 263 | tee VV.log 
    ...
    ../multiLepSearch/util/run_ss_selection.py --driver direct -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --outputTag ${tag} -o ${k} -w -a 0 --study ${st} --mcMatch dR --doSys 0 --ChargeID 1 --conf ${SUSYconf} --grl ${grl} | tee data.log  
