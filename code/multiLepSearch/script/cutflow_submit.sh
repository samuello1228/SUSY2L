#!/bin/bash
tag=v11.5.1.Sam1
dataPRW=GoodRunsLists/data16_13TeV/20170720/physics_25ns_20.7.lumicalc.OflLumi-13TeV-009.root
...
if true; then
    ...
    ../multiLepSearch/util/run_ss_selection.py --driver direct -f ${file} --dataPRW ${dataPRW} --mcPRW ${mcPRW} --outputTag ${tag} -o ${k} -w -a 0 --study ${st} --mcMatch dR --doSys 0 --ChargeID 1 --conf ${SUSYconf} --cutflow | tee data.log  
