...
parser.add_option("--dataPRW", help='data pileup reweighting file list', default= 'multiLepSearch/ilumicalc_histograms_None_267073-271595.root')
parser.add_option("--mcPRW", help='mc pileup reweighting file list', default='multiLepSearch/mc15a_defaults.NotRecommended.prw.root')
...
#v_trigNames = ["HLT_e24_lhmedium_L1EM18VH", "HLT_e60_lhmedium", "HLT_e120_lhloose", "HLT_2e12_lhloose_L12EM10VH", "HLT_e17_lhloose_2e9_lhloose", "HLT_e24_lhmedium_L1EM15VH_g25_medium", "HLT_e20_lhmedium_g35_loose", "HLT_e20_lhmedium_2g10_loose", "HLT_g35_loose_L1EM15_g25_loose_L1EM15", "HLT_2g20_tight", "HLT_3g15_loose"]
v_trigNames = ["HLT_mu20_iloose_L1MU15", "HLT_mu40", "HLT_mu60_0eta105_msonly"]


alg = ROOT.ljetSelection()
alg.outputName = "myOutput"
alg.outputTreeName = "evt3l"
for i in v_trigNames: alg.trigNames.push_back(i)
alg.nLepCutExactly = 3
alg.nLepCutMin = 3
