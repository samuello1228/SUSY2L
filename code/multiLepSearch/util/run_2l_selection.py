...
parser.add_option("--grl", help="good run list", default='multiLepSearch/GRL/data15_13TeV.periodAllYear_DetStatus-v73-pro19-08_DQDefects-00-01-02_PHYS_StandardGRL_All_Good_25ns.xml')
parser.add_option("--dataPRW", help='data pileup reweighting file list', default= 'multiLepSearch/prw_Data/ilumicalc_histograms_None_267073-271595.root')
parser.add_option("--mcPRW", help='mc pileup reweighting file list', default='multiLepSearch/prw_MC/mc15a_defaults.NotRecommended.prw.root')
...
#         outname= "user."+os.environ["RUCIO_ACCOUNT"]+"."+ (options.shortName or options.outputTag+".%in:name[4]%")
        ...
        if options.test:
            ...
            #driver.options().setString(ROOT.EL.Job.optGridNFilesPerJob, "MAX")
