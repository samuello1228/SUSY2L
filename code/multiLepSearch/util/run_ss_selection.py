...
parser.add_option("--grl", help="good run list", default='multiLepSearch/GRL/data16_13TeV.periodAllYear_DetStatus-v80-pro20-08_DQDefects-00-02-02_PHYS_StandardGRL_All_Good_25ns.xml')
parser.add_option("--conf", help="selection configuration file", default='multiLepSearch/sel_conf/SUSYTools_multilepAna.txt')
parser.add_option("--dataPRW", help='data pileup reweighting file list', default= 'multiLepSearch/prw_Data/ilumicalc_histograms_None_297730-303560_v80_Nicky.root')
parser.add_option("--mcPRW", help='mc pileup reweighting file list', default='multiLepSearch/prw_MC/merged_prw_mc15c_Slep0d95.root')
