...
// Tue Dec  6 18:25:44 2016 by ROOT version 6.04/14
// from TTree evt2l/a angles tree
// found on file: /afs/cern.ch/work/y/ychan/public/SUSY_NTUP/v7d11/bkg/user.ychan.v7.11.MCBkg.361063.Sherpa_CT10_llll_myOutput.root/user.ychan.9202589._000001.myOutput.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/y/ychan/public/SUSY_NTUP/v7d11/bkg/user.ychan.v7.11.MCBkg.361063.Sherpa_CT10_llll_myOutput.root/user.ychan.9202589._000001.myOutput.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/y/ychan/public/SUSY_NTUP/v7d11/bkg/user.ychan.v7.11.MCBkg.361063.Sherpa_CT10_llll_myOutput.root/user.ychan.9202589._000001.myOutput.root");
      }
