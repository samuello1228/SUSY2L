...
\frametitle{Update}
\begin{itemize}
\item add p-value of the chi2 test for each plot.
\item plot a histogram of p-value
\end{itemize}
\end{frame}

\input{data/expN_signal_OS.tex}
\input{data/expN_signal_SS.tex}

\def \PathToPlot {../plot_signal}
\input{data/plot_signal_OS.tex}
\input{data/plot_signal_SS.tex}

\includegraphics[width=0.75\textwidth]{../plot_signal/fit}
\begin{itemize}
\item Chi2 = 16.001
\item Number of degree of freedom(NDf) = 19
\item p0 = 26.1999 $\pm$ 1.14455
\item Chi2/NDf $<$ 1
\end{itemize}
...
\begin{itemize}
\item The old and new signal samples are likely to be compatible within the statistics.
\end{itemize}
\end{frame}
