...
1 b-jet \\
\small
fake BG scale factor for nonISR: 3.50464 \\
fake BG scale factor for ISR: 4.21815
\end{center}
\end{frame}
...
Control Region \\
\small
fake BG scale factor for nonISR: 4.26277 \\
fake BG scale factor for ISR: 3.80146
\end{center}
\end{frame}
...
\begin{figure}
\includegraphics[width=0.33\textwidth]{\PathToPlot/averageMu_CR_ISR_OS_ee}
\includegraphics[width=0.33\textwidth]{\PathToPlot/averageMu_CR_ISR_OS_mumu}
\includegraphics[width=0.33\textwidth]{\PathToPlot/averageMu_CR_ISR_OS_emu} \\
...
%\input{data/expN_BGVV_CR_OS.tex}
...
%\input{data/expN_BGVV_SR_SS.tex}
