...
\input{data/expN_SR_SS_run1.tex}

\begin{frame}{event yield of VV in run 1 paper}
\includegraphics[width=\textwidth]{data/photo/expNrun1.png}
\end{frame}

\begin{frame}{event yield of VV}
\begin{tabular}{|c|c|c|}
\hline
Signal Region & run 1 & my result \\
\hline
SR$ee$-1     & $2.53\pm0.68$ & $13.9\pm1.3$ \\
\hline
SR$ee$-2     & $0.92\pm0.46$ & $2.8\pm0.4$ \\
\hline
SR$\mu\mu$-1 & $3.64\pm0.85$ & $6.8\pm0.7$ \\
\hline
SR$\mu\mu$-2 & $2.2\pm1.03$ & $16.6\pm0.7$ \\
\hline
SR$e\mu$-1   & $3.7\pm0.89$ & $11.1\pm0.8$ \\
\hline
SR$e\mu$-2   & $1.33\pm0.56$ & $6.0\pm0.4$ \\
\hline
\end{tabular}
\end{frame}

\begin{frame}{event yield of VV after scale}
scale the number of run 1 by 36.47/20.3
\begin{tabular}{|c|c|c|}
\hline
Signal Region & run 1 & my result \\
\hline
SR$ee$-1     & $4.55\pm1.21$ & $13.9\pm1.3$ \\
\hline
SR$ee$-2     & $1.65\pm0.83$ & $2.8\pm0.4$ \\
\hline
SR$\mu\mu$-1 & $6.54\pm1.53$ & $6.8\pm0.7$ \\
\hline
SR$\mu\mu$-2 & $3.95\pm1.85$ & $16.6\pm0.7$ \\
\hline
SR$e\mu$-1   & $6.65\pm1.61$ & $11.1\pm0.8$ \\
\hline
SR$e\mu$-2   & $2.39\pm1.01$ & $6.0\pm0.4$ \\
\hline
\end{tabular}
\end{frame}

\input{data/expN_SR_SS_run1_BGVV.tex}
\input{data/plot_SR_SS_run1.tex}

\section{Comparison of expected number of signal}
\begin{frame}{Comparison of expected number of signal}
