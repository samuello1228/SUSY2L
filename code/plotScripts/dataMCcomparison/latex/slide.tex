...
\begin{itemize}
\normalsize
\item Applied charge flip MC correction to Zee samples
\end{itemize}
\end{frame}
...
\begin{itemize}
\item The correction reduces the Zee charge flip BG \\
For non-ISR, from 32609 to 27124 \\
For ISR, from 22924 to 19508
\end{itemize}
\end{frame}
...
\frametitle{plan}
\begin{itemize}
\item more checking for Zee charge flip background.
\end{itemize}
\end{frame}
...
\input{data/expN_nonISR.tex}
\input{data/expN_BGVV_nonISR.tex}
...
\input{data/expN_ISR.tex}
\input{data/expN_BGVV_ISR.tex}
