\begin{frame}{For SR\_SS\_opt \\ $\pt$ of the leading lepton}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\pt$ of the subleading lepton}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\eta$ of the leading lepton}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\eta$ of the subleading lepton}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\phi$ of the leading lepton}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{ll}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ Dilepton $\pt$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $E_{\text{T}}^{\text{miss}}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{T2}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{\text{T}}$ of the leading lepton}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{\text{T}}$ of the subleading lepton}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\pt$ of the leading jet}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\eta$ of the leading jet}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ Number of jets}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ Number of b-jets}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ Number of central jets}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $|\Delta\phi_{ll}|$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $|\Delta\phi_{ll,\text{MET}}|$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $|\Delta\phi_{\text{jet0,MET}}|$}
\Wider[5em]{
\includegraphics[width=0.33\textwidth]{jets_MET_dPhi_SR_SS_ee_1_opt_0}
\includegraphics[width=0.33\textwidth]{jets_MET_dPhi_SR_SS_mumu_1_opt_0}
\includegraphics[width=0.33\textwidth]{jets_MET_dPhi_SR_SS_emu_1_opt_0} \\
\includegraphics[width=0.33\textwidth]{jets_MET_dPhi_SR_SS_ee_2_opt_0}
\includegraphics[width=0.33\textwidth]{jets_MET_dPhi_SR_SS_mumu_2_opt_0}
\includegraphics[width=0.33\textwidth]{jets_MET_dPhi_SR_SS_emu_2_opt_0}
}
\end{frame}

\begin{frame}{For SR\_SS\_opt \\ $|\Delta\eta_{ll}|$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $E_{\text{T}}^{\text{miss,rel}}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{\text{eff}}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{\text{T}}^{\text{max}}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{lj}$/$m_{ljj}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{jj}$}
\Wider[5em]{
