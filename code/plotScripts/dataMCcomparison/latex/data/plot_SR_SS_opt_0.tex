\begin{frame}{For SR\_SS\_opt \\ $\pt^{l1}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\pt^{l2}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\eta^{l1}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\eta^{l2}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\phi^{l1}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $\pt^{ll}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{\text{T}}^{l1}$}
\Wider[5em]{
...
\begin{frame}{For SR\_SS\_opt \\ $m_{\text{T}}^{l2}$}
\Wider[5em]{
