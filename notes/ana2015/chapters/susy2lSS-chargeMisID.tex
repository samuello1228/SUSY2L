...
\centering
\subfloat{
  \subfloat{\includegraphics[page=1,scale=0.35]{ChargeMisID/1007-MC-comparison/EtaPt.pdf}}
  \subfloat{\includegraphics[page=2,scale=0.35]{ChargeMisID/1007-MC-comparison/EtaPt.pdf}}
}

\subfloat{
  \subfloat{\includegraphics[page=3,scale=0.35]{ChargeMisID/1007-MC-comparison/EtaPt.pdf}}
  \subfloat{\includegraphics[page=4,scale=0.35]{ChargeMisID/1007-MC-comparison/EtaPt.pdf}}
}

\subfloat{
  \subfloat{\includegraphics[page=5,scale=0.35]{ChargeMisID/1007-MC-comparison/EtaPt.pdf}}
  \subfloat{\includegraphics[page=6,scale=0.35]{ChargeMisID/1007-MC-comparison/EtaPt.pdf}}
}
\end{figure}
...
\centering
\subfloat{
  \subfloat{\includegraphics[page=1,scale=0.35]{ChargeMisID/1007-MC-comparison/PtEta.pdf}}
}
...
\begin{figure}[h!]
\centering
\subfloat[][Comparison of rates for LooseBaseline electrons]{\includegraphics[scale=0.39]{ChargeMisID/WoSub_loose/Pt.pdf}}
...
\begin{figure}[h!]
\centering
\subfloat[][Comparison of rates for LooseBaseline electrons]{\includegraphics[scale=0.39]{ChargeMisID/WoSub_loose/Eta.pdf}}
\subfloat[][Comparison of rates for Signal electrons]{
...
\centering
\subfloat{
  \subfloat{\includegraphics[page=1,scale=0.25]{ChargeMisID/WoSub_loose/EtaPt.pdf}}
  \subfloat{\includegraphics[page=2,scale=0.25]{ChargeMisID/WoSub_loose/EtaPt.pdf}}
  \subfloat{\includegraphics[page=3,scale=0.25]{ChargeMisID/WoSub_loose/EtaPt.pdf}}
}

\subfloat{
  \subfloat{\includegraphics[page=4,scale=0.25]{ChargeMisID/WoSub_loose/EtaPt.pdf}}
  \subfloat{\includegraphics[page=5,scale=0.25]{ChargeMisID/WoSub_loose/EtaPt.pdf}}
  \subfloat{\includegraphics[page=6,scale=0.25]{ChargeMisID/WoSub_loose/EtaPt.pdf}}
}

\subfloat{
  \subfloat{\includegraphics[page=1,scale=0.25]{ChargeMisID/WoSub_loose/PtEta.pdf}}
  \subfloat{\includegraphics[page=2,scale=0.25]{ChargeMisID/WoSub_loose/PtEta.pdf}}
  \subfloat{\includegraphics[page=3,scale=0.25]{ChargeMisID/WoSub_loose/PtEta.pdf}}
}

\subfloat{
  \subfloat{\includegraphics[page=5,scale=0.25]{ChargeMisID/WoSub_loose/PtEta.pdf}}
  \subfloat{\includegraphics[page=6,scale=0.25]{ChargeMisID/WoSub_loose/PtEta.pdf}}
  \subfloat{\includegraphics[page=7,scale=0.25]{ChargeMisID/WoSub_loose/PtEta.pdf}}
}
...
\centering
\subfloat{
  \subfloat{\includegraphics[page=1,scale=0.25]{ChargeMisID/WoSub_signal/EtaPt.pdf}}
  \subfloat{\includegraphics[page=2,scale=0.25]{ChargeMisID/WoSub_signal/EtaPt.pdf}}
  \subfloat{\includegraphics[page=3,scale=0.25]{ChargeMisID/WoSub_signal/EtaPt.pdf}}
}

\subfloat{
  \subfloat{\includegraphics[page=4,scale=0.25]{ChargeMisID/WoSub_signal/EtaPt.pdf}}
  \subfloat{\includegraphics[page=5,scale=0.25]{ChargeMisID/WoSub_signal/EtaPt.pdf}}
  \subfloat{\includegraphics[page=6,scale=0.25]{ChargeMisID/WoSub_signal/EtaPt.pdf}}
}

\subfloat{
  \subfloat{\includegraphics[page=1,scale=0.25]{ChargeMisID/WoSub_signal/PtEta.pdf}}
  \subfloat{\includegraphics[page=2,scale=0.25]{ChargeMisID/WoSub_signal/PtEta.pdf}}
  \subfloat{\includegraphics[page=3,scale=0.25]{ChargeMisID/WoSub_signal/PtEta.pdf}}
}

\subfloat{
  \subfloat{\includegraphics[page=5,scale=0.25]{ChargeMisID/WoSub_signal/PtEta.pdf}}
  \subfloat{\includegraphics[page=6,scale=0.25]{ChargeMisID/WoSub_signal/PtEta.pdf}}
  \subfloat{\includegraphics[page=7,scale=0.25]{ChargeMisID/WoSub_signal/PtEta.pdf}}
}
